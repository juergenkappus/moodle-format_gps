...
/**
 * Strings for component 'format_gps', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   format_gps
 * @copyright kamedia - 2014 Barry Oosthuizen
 * @author    Barry Oosthuizen http://www.kamedia.de
...
$string['page-course-view-gps'] = 'Any course main page in GPS Format Free';
$string['page-course-view-gps-x'] = 'Any course page in GPS Format Free';
$string['pluginname'] = 'GPS Format Free';
$string['pluginname_help'] = 'The GPS Format Free allows you to restrict a topic to a specific GPS location. The student has to be inside the specified location radius to get access to the topic.';
$string['radius'] = 'Radius allowed';
